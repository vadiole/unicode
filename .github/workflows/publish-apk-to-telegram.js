module.exports = ({github, context}) => {
  ...
  const thumbnail = fs.readFileSync('./app/src/assets/logo-320.png');
  ...
  const fileOptions = {filename: apkName, thumbnail: thumbnail, contentType: 'application/vnd.android.package-archive'};
